  ...
  dataSources: [
    {
      ...
      sourceName: 'dicomweb',
      configuration: {
        friendlyName: 'DICOMWeb Server / Orthanc',
        name: 'orthanc',
        wadoUriRoot: 'https://djhld78q4lj84.cloudfront.net/dicom-web',
        qidoRoot: 'https://djhld78q4lj84.cloudfront.net/dicom-web',
        wadoRoot: 'https://djhld78q4lj84.cloudfront.net/dicom-web',
